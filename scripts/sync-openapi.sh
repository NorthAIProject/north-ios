...
GOLDEN_SOURCES=(activity auth capture checkins coach dashboard documents exercises fitness goals health insights media memories onboarding reports settings workouts)
