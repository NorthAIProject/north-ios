...
GOLDEN_SOURCES=(activity auth calculator capture care checkins coach dashboard day decisions documents exercises fitness goals health insights meals media memories mind news nudges onboarding reports settings workouts)
