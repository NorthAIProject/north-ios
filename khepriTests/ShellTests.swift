...
struct RouterTests {
    @Test(arguments: [
        ...
        ("/app/check-ins", .section("check-ins")),
        ("khepri://care", .section("care")),
        ("khepri://more", .tab(.more)),
        ("khepri://training/next", .nextWorkout(start: false)),
        ("khepri://training/next/start", .nextWorkout(start: true)),
